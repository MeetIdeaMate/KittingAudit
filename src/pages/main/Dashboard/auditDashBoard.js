...
const Dashboard = () => {
    ...
    const cardData = (source) => [
        ...
        },
        {
            ...
            labels: ["Dispatched", "Not Dispatch", "Delayed Count", "On-Time Count "],
            values: [(source?.dispatchDetails?.completedDispatchCount || 0), (source?.dispatchDetails?.pendingDispatchCount || 0), (source?.dispatchDetails?.delayedDispatchCount || 0), (source?.dispatchDetails?.onTimeDispatchCount || 0),],
            colors: ["#10b981", "#ef4444"],
            bg: "#f5f2fa",
            border: "#e2d8f3",
        },
