            ...
            <div style={{ display: "flex", justifyContent: "space-between", gap: "20px" }}>
                    ...
                    <div className="flexible">
                        <div className="dashboard-card">
                            <div className="dashboard-upload-icon">
                                <img className="image" src={totalUploadedIcon} alt="Total Uploaded Excel" />
                            </div>
                        ...
                        <div className="dashboard-card">
                            <div className="dashboard-totalCrnumber-icon">
                                <img className="image" src={totalCrNumberIcon} alt="Total CR Number" />
                            </div>
                            <h5 className="title-color">Total CR Number</h5>
                            <p className="dashboard-card-value">{dashboardData?.totalCrNumberCount}</p>
                        </div>
                        <div className="dashboard-card">
                            <div className="dashboard-complete-icon">
                                <img className="image" src={toitalCompleteIcon} alt="Completed CR Number" />
                            </div>
                            <h5 className="title-color">Completed CR Number</h5>
                            <p className="dashboard-card-value">{dashboardData?.completedCrNumberCount}</p>
                        </div>
                        <div className="dashboard-card">
                            <div className="dashboard-pending-icon">
                                <img className="image" src={totalPendingIcon} alt="Pending CR Number" />
                            </div>
                            <h5 className="title-color">Pending CR Number</h5>
                    ...
                    <div className="dashboard-chart-container">
                        <div className="flexible">
                            <div>
                                ...
                                <p className="dashboard-card-month-subtitle">Monthly Uploads of Excel Status</p>
                            </div>
                            <div>
                                <DatePicker picker="year" value={dayjs().year(year)} onChange={(date) => handleYearChange(date)} />
                            </div>
                        </div>
                ...
                <div style={{ width: "40%" }}>
                    <div className="dashboard-search-container">
                        <label style={{ fontWeight: "600", fontSize: "14px" }}>Select CR Number</label>
                        <UiSelect
                            isStyle={true}
                    ...
                    <div className="flexible">
                        <div className="dashboard-card">
                            <div className="dashboard-total-firm-card flexible">
                                <img className="image" src={totalFirmIcon} alt="Total Firm" />
                            </div>
                            <h5 className="dashboard-card-month-subtitle">Total Firm</h5>
                            <p className="dashboard-crNumber-card">{crNumberSummary?.totalFimNumbers || 0}</p>
                        </div>
                        <div className="dashboard-card">
                            <div className="dashboard-toal-qty-card">
                                <img className="image" src={totalQuantityIcon} alt="Total Quantity" />
                            </div>
                            <h5 className="dashboard-card-month-subtitle">Total Quantity</h5>
                            <p className="dashboard-crNumber-card">{crNumberSummary?.totalQty || 0}</p>
                        </div>
                        <div className="dashboard-card">
                            <div className="dashboard-card-label">
                                <img className="image" src={labeledIcon} alt="Labeled" />
                            </div>
                            <h5 className="dashboard-card-month-subtitle">Labeled</h5>
                            <p className="dashboard-crNumber-card">{crNumberSummary?.totalLabeledQty || 0}</p>
                        </div>
                        <div className="dashboard-card">
                            <div className="dashboard-total-firm-card flexible">
                                <img className="image" src={scannedIcon} alt="Scanned" />
                            </div>
                            <h5 className="dashboard-card-month-subtitle">Scanned</h5>
                            <p className="dashboard-crNumber-card">{crNumberSummary?.totalScannedQty || 0}</p>
                        </div>
                    </div>
