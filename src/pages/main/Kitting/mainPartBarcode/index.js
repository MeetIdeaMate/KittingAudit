...
export const MainPartBarcode = ({
    ...
    return <React.Fragment>
        <div>
            ...
            <UiTextBox value={lastBarcode} name={"lastBarcode"} ref={inputRef} onChange={(field) => handleChangeFieldValue(field?.target?.value)} onKeyPress={(field) => hanldePressEnter(field)} placeholder="Bar Code ID"/>
            {
